...
from api_games_v1 import views_auth, views_templates
...
urlpatterns = [
    ...
    url(r'^rest-auth/registration/usercheck/',
        views_auth.UserExistsCheck.as_view()),
    url(r'^rest-auth/registration/emailcheck/',
        views_auth.EmailExistsCheck.as_view()),
    url(r'^rest-auth/registration/', include('rest_auth.registration.urls')),

    # Games API
    url(r'^api/v1/', include('api_games_v1.urls', namespace='api_v1')),
]
